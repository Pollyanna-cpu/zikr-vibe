...
class DeepLinks {
  ...
  /// Codes generated by `create_circle` are canonical 8-char uppercase
  /// alnum strings. Reject anything else so a malformed link doesn't get
  /// stored and silently fail at the join RPC.
  static final _codeRe = RegExp(r'^[A-Z0-9]{8}$');
